...
void function2() {
    ...
    int max = (a < b) ? max=b : max=a ; //"if"(in left) is b, "else"(in right) is a
...
void function3() {
    ...
    int result = (a > b) ? b : a ; //"if"(in left) is b, "else"(in right) is a
...
void function4() { //ternary initialization
    ...
    int speed = fast ? 100 : 150 ; //conditional is fast, "if"(in left) is 100, "else"(in right) is 150
